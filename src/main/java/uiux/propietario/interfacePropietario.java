...
public class interfacePropietario extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(interfacePropietario.class.getName());
    private int xOffset, yOffset;

    public interfacePropietario() {
        initComponents();
        hacerVentanaMovible();
        mostrarContenido();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Propiedades en renta");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new interfacePropietario().setVisible(true));
    }
